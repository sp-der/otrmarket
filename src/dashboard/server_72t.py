...
def _patch_minimal_dashboard_assets_72t() -> None:
    ...
    css_tag = '<link rel="stylesheet" href="/market/assets/dashboard-minimal72t.css?v=7.2t3">'
    js_tag = '<script src="/market/assets/dashboard-minimal72t.js?v=7.2t3" defer></script>'
    changed = False
