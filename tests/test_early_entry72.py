...
class EarlyEntry72Tests(unittest.TestCase):
    ...
    def test_confirmed_setup_can_activate_earlier_strong_geometry(self):
        ...
        setup = SimpleNamespace(
            ...
            target_price=85.0,
            risk_reward=3.0,
            metadata={"entry_type": "OTE_79", "risk_multiplier": 0.50},
        )
    ...
    def test_weak_prearm_does_not_replace_premium_final_geometry(self):
        ...
        self.assertAlmostEqual(result.entry_price, 97.0)
